...
that cannot exist. See :mod:`SpAM_Simulations.models.canvas` for the geometry and its calibration.
...
from SpAM_Simulations.models.canvas import CanvasSpec, DEFAULT_SOFTNESS, make_canvas_trial_simulator
